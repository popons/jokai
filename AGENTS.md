...
- footer の横幅を触るときは、左下赤メモを右下連絡先ブロックの直前まで広げる前提を崩さず、連絡先ブロック自体は固定のまま守ること。
