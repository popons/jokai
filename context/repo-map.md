...
| `web-src/app.css` | 編集画面/プレビュー画面の UI スタイル。非印刷UIの余白密度、sticky な表示コントロール帯、折りたたみ header / summary、responsive 時の並び替えもここで制御する |
