...
| `issue_thumbnail_caches` | issue 一覧サムネ cache | print shell 由来 PDF の 1ページ目 PNG を `source_version` 単位で保持し、`/api/issues/{id}/list-thumbnail` の正本 cache とする |
